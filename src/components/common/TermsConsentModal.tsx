...
export default function TermsConsentModal({
  ...
  // Terms content
  const termsContent = `
ข้อตกลงและเงื่อนไขการใช้งาน NurseShift

1. คำนิยาม
"แอปพลิเคชัน" หมายถึง NurseShift ซึ่งเป็นแพลตฟอร์มสำหรับการประกาศหาคนแทนเวรของบุคลากรทางการแพทย์
...
นโยบายความเป็นส่วนตัว NurseShift
...
9. การติดต่อ
หากมีคำถามเกี่ยวกับนโยบายนี้ กรุณาติดต่อ: privacy@nurseshift.app
